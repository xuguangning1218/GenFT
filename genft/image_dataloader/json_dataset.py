...
class JSONDataset(torch.utils.data.Dataset):
    def __init__(self, dataset_dir, dataset_name, split):
        # assert split in {
        #     "train",
        #     "val",
        #     "test",
...
class CUB200Dataset(JSONDataset):
    ...
    def __init__(self, dataset_dir, dataset_name, split):
        super(CUB200Dataset, self).__init__(dataset_dir, dataset_name, split)
...
class CarsDataset(JSONDataset):
    ...
    def __init__(self, dataset_dir, dataset_name, split):
        super(CarsDataset, self).__init__(dataset_dir, dataset_name, split)
...
class DogsDataset(JSONDataset):
    ...
    def __init__(self, dataset_dir, dataset_name, split):
        super(DogsDataset, self).__init__(dataset_dir, dataset_name, split)
...
class FlowersDataset(JSONDataset):
    ...
    def __init__(self, dataset_dir, dataset_name, split):
        super(FlowersDataset, self).__init__(dataset_dir, dataset_name, split)
...
class NabirdsDataset(JSONDataset):
    ...
    def __init__(self, dataset_dir, dataset_name, split):
        super(NabirdsDataset, self).__init__(dataset_dir, dataset_name, split)
